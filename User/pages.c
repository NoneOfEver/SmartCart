...
void renderMainPage()
{
    ...
    LCD_ShowString(570,200,5*BIGCHAR,32,32,"C:Pay");
    //LCD_ShowString(600,240,4*BIGCHAR,32,32,"item");
    LCD_ShowString(100,345,9*BIGCHAR,32,32,"D:current");
    LCD_ShowString(130,385,4*BIGCHAR,32,32,"item");
    LCD_ShowString(320,345,6*BIGCHAR,32,32,"E:Back");
    LCD_ShowString(570,345,5*BIGCHAR,32,32,"F:WPU");
...
void Pages_add()
{
        ...
        LCD_Draw_Circle(760,24,20);
        //LCD_Color_Fill(40,24,760,456,GRAY);
        LCD_ShowString(250,250,11*BIGCHAR,32,32,"Please show");
